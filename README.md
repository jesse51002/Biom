...
Then open a new terminal, so it can find `bun`.

### 2. Get the code

You need git. macOS offers to install it the first time you run it; on Windows, get it from [git-scm.com](https://git-scm.com).

```
git clone https://github.com/jesse51002/Biom.git
```
...
- **Your single source of truth.** Docs, tools and automations, tables and data, boards and roadmaps, a second brain, dashboards, diagrams, forms. One folder.
